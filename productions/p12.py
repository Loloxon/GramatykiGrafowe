...
class P12(Production):
    ...
    def transform(
        ...
        node_1_4 = graph.split_edge(
            node_mapper(1),
            node_mapper(4),
            not graph.get_edge_between(node_mapper(1), node_mapper(4)).is_border,
        )
        ...
        node_center = graph.create_center_node(
            [node_1_4, node_3_5, node_5_2, node_mapper(6), node_mapper(7)]
        )

        graph.add_edge(node_1_4, node_center)
        ...
        graph.add_hyperedge([node_1_4, node_mapper(1), node_mapper(6), node_center])
        graph.add_hyperedge([node_mapper(7), node_mapper(4), node_1_4, node_center])
        graph.add_hyperedge([node_mapper(3), node_3_5, node_center, node_mapper(7)])
