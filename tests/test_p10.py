...
class TestP10(TestProduction, TestCase):
    ...
    def test_apply_exact_graph(self):
        ...
        visualize_hypergraph(nx_tested_graph, "TEST - Graph before P10", True, True, True)

        p10 = P10()
        successful, tested_hypergraph_after_p10 = p10.apply(tested_hypergraph)

        nx_graph_after_production = tested_hypergraph_after_p10.parse_hypergraph_to_networkx()
        visualize_hypergraph(nx_graph_after_production, "TEST - Graph after P10", True, True, True)

        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p10, expected_hypergraph))
    ...
    def test_apply_extended_graph(self):
        ...
        edges = [
            ...
            Edge(nodes[3], nodes[4], True),  # 3-4
            Edge(nodes[4], nodes[0], True),  # 4-1
            Edge(nodes[4], nodes[6], True),
            Edge(nodes[3], nodes[7], True),
            Edge(nodes[6], nodes[8], True),
    ...
    def test_apply_invalid_graph_missing_node(self):
        ...
        edges = [
            Edge(nodes[0], nodes[4], True),  # 1-6
            Edge(nodes[4], nodes[1], True),  # 6-2
            Edge(nodes[1], nodes[2], True),  # 2-5
            Edge(nodes[2], nodes[3], True),  # 5-3
        ]
        hyperedges = [
    ...
    def test_apply_invalid_graph_invalid_label(self):
        nodes = [
            ...
            Node(1, 1, False),  # 3
            Node(0, 1, False),  # 4
            Node(0.5, 0, True, label="D")  # 6 - hanging node
        ]
        edges = [
            Edge(nodes[0], nodes[5], True),  # 1-6
            Edge(nodes[5], nodes[1], True),  # 6-2
