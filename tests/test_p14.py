...
class TestP14(TestProduction, TestCase):
    def test_apply_exact_graph(self):
        ...
        expected_hypergraph = p14._right_side
        successful, tested_hypergraph_after_p14 = p14.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p14, expected_hypergraph))
    ...
    def test_apply_extended_graph(self):
        ...
        edges = [
            ...
            Edge(nodes[3], nodes[9], True),  # 4 - 10
            Edge(nodes[9], nodes[10], True),  # 10 - 11
            Edge(nodes[10], nodes[6], False),  # 11 - 7
            Edge(nodes[10], nodes[11], True),  # 11 - 12
            Edge(nodes[11], nodes[0], True),  # 12 - 1
        ]
        hyperedges = [
            HyperEdge(
            ...
            HyperEdge(
                [nodes[6], nodes[3], nodes[9], nodes[10]], True, label="Q"
            ),
            HyperEdge(
                [nodes[10], nodes[11], nodes[0], nodes[6]], True, label="Q"
            ),
        ]
    ...
    def test_apply_invalid_graph_missing_node(self):
        ...
        tested_hypergraph = HyperGraph(nodes, edges, hyperedges)
        successful, _ = P14().apply(tested_hypergraph)
