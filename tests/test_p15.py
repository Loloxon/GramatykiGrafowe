...
class TestP15(TestProduction, TestCase):
    def test_apply_exact_graph(self):
        p15 = P15()
        tested_hypergraph = p15._left_side
        expected_hypergraph = p15._right_side
        successful, tested_hypergraph_after_p15 = p15.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p15, expected_hypergraph))
    ...
    def test_apply_extended_graph(self):
        nodes = [
            ...
            Node(0, 0.5, True),  # 7
            Node(0.5, 1, True),  # 8
            Node(1.25, 0.75, True),  # 9
            Node(1.25, 0.25, True),  # 10
        ...
        edges = [
            ...
            Edge(nodes[11], nodes[6], False),  # 12 - 7
            Edge(nodes[11], nodes[12], True),  # 12 - 13
            Edge(nodes[12], nodes[0], True),  # 13 - 1
        ]
        hyperedges = [
            HyperEdge(
            ...
            HyperEdge(
                [nodes[6], nodes[3], nodes[10], nodes[11]], True, label="Q"
            ),
            HyperEdge(
                [nodes[11], nodes[12], nodes[0], nodes[6]], True, label="Q"
            ),
        ]
    ...
    def test_apply_invalid_graph_missing_node(self):
        ...
        tested_hypergraph = HyperGraph(nodes, edges, hyperedges)
        successful, _ = P15().apply(tested_hypergraph)
    ...
    def test_apply_invalid_graph_invalid_label(self):
        nodes = [
            ...
            Node(0.5, 1, True),  # 8
            Node(1.25, 0.75, True),  # 9
            Node(1.25, 0.25, True, label='A'),  # 10
        ]
        edges = [
            Edge(nodes[0], nodes[5], True),  # 1 - 6
            Edge(nodes[5], nodes[1], True),  # 6 - 2
