...
class TestP3(TestProduction, TestCase):
    ...
    def test_apply_exact_graph(self):
        ...
        p3 = P3()
        successful, tested_hypergraph_after_p3 = p3.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p3, expected_hypergraph))
