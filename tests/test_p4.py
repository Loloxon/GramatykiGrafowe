...
class TestP4(TestProduction, TestCase):
    ...
    def test_apply_exact_graph(self):
        ...
        p4 = P4()
        successful, tested_hypergraph_after_p4 = p4.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p4, expected_hypergraph))
