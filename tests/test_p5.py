...
class TestP5(TestProduction, TestCase):
    ...
    def test_apply_exact_graph(self):
        ...
        p5 = P5()
        successful, tested_hypergraph_after_p5 = p5.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p5, expected_hypergraph))
