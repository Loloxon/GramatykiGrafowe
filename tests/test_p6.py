...
class TestP6(TestProduction, TestCase):
    ...
    def test_apply_exact_graph(self):
        ...
        p6 = P6()
        successful, tested_hypergraph_after_p6 = p6.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p6, expected_hypergraph))
