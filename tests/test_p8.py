...
class TestP8(TestProduction, TestCase):
    ...
    def test_apply_exact_graph(self):
        ...
        p8 = P8()
        successful, tested_hypergraph_after_p8 = p8.apply(tested_hypergraph)
        self.assertTrue(successful)
        self.assertTrue(equals(tested_hypergraph_after_p8, expected_hypergraph))
    ...
    def test_apply_extended_graph(self):
        ...
        edges = [Edge(nodes[1], nodes[4], False),
                 Edge(nodes[2], nodes[4], False),
                 Edge(nodes[2], nodes[7], True),
                 Edge(nodes[3], nodes[8], True),
                 ...
                 Edge(nodes[5], nodes[9], True),
                 Edge(nodes[1], nodes[9], True)]
        hyperedges = [HyperEdge([nodes[0], nodes[1], nodes[2], nodes[3]], False),
                      HyperEdge([nodes[2], nodes[4], nodes[5], nodes[6]], True),
    ...
    def test_apply_invalid_graph_missing_node(self):
        ...
        edges = [Edge(nodes[1], nodes[4], False),
                 Edge(nodes[2], nodes[4], False)]
        hyperedges = [HyperEdge([nodes[0], nodes[1], nodes[2], nodes[3]], False),
                      HyperEdge([nodes[2], nodes[4], nodes[5]], True)]
        tested_hypergraph = HyperGraph(nodes, edges, hyperedges)
